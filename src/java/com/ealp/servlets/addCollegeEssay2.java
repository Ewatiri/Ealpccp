 ...
 * @author eva
 */
public class addCollegeEssay2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (isFormField) {
                        if (fileItem.getFieldName().equalsIgnoreCase("essayid")) {
                            ...
                            ce.setEssayid(Integer.parseInt(fileItem.getString()));
                            resource.setEssayid(ce);
                            ...
                            //System.out.print(resource.getScore());
                        }
                    } else {
                        //System.out.print();
                        ...
                        try {
                            ...
                            if (type.equalsIgnoreCase("application/msword") || (type.equalsIgnoreCase("application/vnd.openxmlformats-officedocument.wordprocessingml.document"))) {
                                ...
                                String p = "http://localhost:8080/Ealpccp/ealp/mod2/essays/" + fileItem.getName();

                                String path = "/var/webapp/ealp/mod2/essays/";
                ...
                if (save) {
                    Document old = sch.getDocEssay(scholar, resource.getEssayid());
